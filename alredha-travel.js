        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/alredhatravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض اسطنبول',
        image_1: ['عروض-شركة-الرضا/عروض-اسطنبول/عرض-اسطنبول-1.jpg', 'عرض اسطنبول - 7 أيام'],
        image_2: ['عروض-شركة-الرضا/عروض-اسطنبول/عرض-اسطنبول-2.jpg', 'عرض اسطنبول - 5 أيام'],
        image_3: ['عروض-شركة-الرضا/عروض-اسطنبول/عرض-اسطنبول-3.jpg', 'عرض اسطنبول - 7 أيام'],
        image_4: ['عروض-شركة-الرضا/عروض-اسطنبول/عرض-اسطنبول-4.jpg', 'عرض اسطنبول - 7 أيام'],
    },

    {
        title: 'عروض ميلان',
        image_1: ['عروض-شركة-الرضا/عروض-ميلان/عرض-ميلان-1.jpg', 'عرض ميلان - 7 أيام'],
        image_2: ['عروض-شركة-الرضا/عروض-ميلان/عرض-ميلان-2.jpg', 'عرض ميلان - 7 أيام'],
    },

    {
        title: 'عروض روما',
        image_1: ['عروض-شركة-الرضا/عروض-روما/عرض-روما-1.jpg', 'عرض روما - 7 أيام'],
    },
    
    {
        title: 'عروض لندن',
        image_1: ['عروض-شركة-الرضا/عروض-لندن/عرض-لندن-1.jpg', 'عرض لندن - 6 أيام'],
        image_2: ['عروض-شركة-الرضا/عروض-لندن/عرض-لندن-2.jpg', 'عرض لندن - 5 أيام'],
    },

    {
        title: 'عروض جورجيا',
        image_1: ['عروض-شركة-الرضا/عروض-جورجيا/عرض-جورجيا-1.jpg', 'عرض جورجيا - 6 أيام'],
        image_2: ['عروض-شركة-الرضا/عروض-جورجيا/عرض-جورجيا-2.jpg', 'عرض جورجيا - 5 أيام'],
    },


    {
        title: 'عروض اذربيجان',
        image_1: ['عروض-شركة-الرضا/عروض-اذربيجان/عرض-اذربيجان-1.jpg', 'عرض اذربيجان - 6 أيام'],
        image_2: ['عروض-شركة-الرضا/عروض-اذربيجان/عرض-اذربيجان-2.jpg', 'عرض اذربيجان - 7 أيام'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+97338998444?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/alredhatravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة الرضا على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة الرضا على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة الرضا على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة الرضا للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة الرضا للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة الرضا`;
            img.title = `مكتب سياحي - شركة الرضا`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+97338998444";
