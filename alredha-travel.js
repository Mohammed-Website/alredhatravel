...
const sectionData = [
    {
        title: 'أحدث العروض',
        image_1: ['عروض-شركة-الرضا/احدث-العروض/1.jpg', 'رحلة عيد الفطر | اسطنبول 7 أيام'],
        image_2: ['عروض-شركة-الرضا/احدث-العروض/2.jpg', 'رحلة عيد الفطر | اسطنبول & طرابزون 9 أيام'],
        image_3: ['عروض-شركة-الرضا/احدث-العروض/3.jpg', 'رحلة عيد الفطر | مشهد 8 أيام'],
        image_4: ['عروض-شركة-الرضا/احدث-العروض/4.jpg', 'رحلة عيد الفطر | تايلاند 7 أيام'],
        image_5: ['عروض-شركة-الرضا/احدث-العروض/5.jpg', 'رحلة عيد الفطر | اسطنبول 5 أيام'],
    },

    {
        title: 'عروض اسطنبول',
        image_1: ['عروض-شركة-الرضا/اسطنبول/1.jpg', 'رحلة اسطنبول | 7 أيام'],
        image_2: ['عروض-شركة-الرضا/اسطنبول/2.jpg', 'رحلة اسطنبول | 5 أيام'],
        image_3: ['عروض-شركة-الرضا/اسطنبول/3.jpg', 'رحلة اسطنبول | 7 أيام'],
        image_4: ['عروض-شركة-الرضا/اسطنبول/4.jpg', 'رحلة اسطنبول | 7 أيام'],
    },

    {
        title: 'عروض ميلان',
        image_1: ['عروض-شركة-الرضا/ميلان/1.jpg', 'رحلة ميلان | 7 أيام'],
        image_2: ['عروض-شركة-الرضا/ميلان/2.jpg', 'رحلة ميلان | 7 أيام'],
    },

    {
        title: 'عروض روما',
        image_1: ['عروض-شركة-الرضا/روما/1.jpg', 'رحلة روما | 7 أيام'],
    },
    
    {
        title: 'عروض لندن',
        image_1: ['عروض-شركة-الرضا/لندن/1.jpg', 'رحلة لندن | 6 أيام'],
        image_2: ['عروض-شركة-الرضا/لندن/2.jpg', 'رحلة لندن | 5 أيام'],
    },

    {
        title: 'عروض جورجيا',
        image_1: ['عروض-شركة-الرضا/جورجيا/1.jpg', 'رحلة جورجيا | 6 أيام'],
        image_2: ['عروض-شركة-الرضا/جورجيا/2.jpg', 'رحلة جورجيا | 5 أيام'],
    },


    {
        title: 'عروض اذربيجان',
        image_1: ['عروض-شركة-الرضا/اذربيجان/1.jpg', 'رحلة اذربيجان | 6 أيام'],
        image_2: ['عروض-شركة-الرضا/اذربيجان/2.jpg', 'رحلة اذربيجان | 7 أيام'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+97338998444?text=💎%20طلب%20حجز%20عرض%20جديد%20💎%0A%0Aسلام%20عليكم،%20حاب%20أسأل%20عن%20عرض%0A*${encodeURIComponent(text)}*%0Aوحاب%20أعرف%20تفاصيل%20أكثر%20عن%20عروضكم%20المشابهة.%0A%0A🔗%20رابط%20صورة%20العرض:%0Ahttps://mohammed-website.github.io/alredhatravel/${encodeURIComponent(src)}%0A%0Aبإنتظار%20ردكم%20وشكرًا%20لكم`;
